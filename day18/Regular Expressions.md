...
txt = 'This regular expression example was made on December 6,  2019 and revised on July 8, 2021'
matches = re.findall(regex_pattern, txt)
print(matches)  # ['6', '2023', '8', '2024'] - now, this is better!
```
...
```py
txt = 'This regular expression example was made on December 6,  2023 and revised on July 8, 2024'

...
# main.py file
import mymodule
print(mymodule.generate_full_name('Fidel', 'Ouma')) # Fidel Ouma
```
...
print(generate_full_name('Fidel','Ouma'))
...
```sh
python script.py Fidel 30DaysOfPython
```

The result:

```sh
Welcome Fidel. Enjoy  30DayOfPython challenge! 
```

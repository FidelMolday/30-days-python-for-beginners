...
Enter your name:Fidel
Year you born:20
You are Fidel. And your age is 20.
...
```py
countries = ['Kenya', 'Sweden', 'Norway', 'Denmark', 'Iceland']
fin, sw, nor, *rest = countries
print(fin, sw, nor, rest)   # Kenya Sweden Norway ['Denmark', 'Iceland']
...
dct = {'name':'Fidel', 'country':'Kenya', 'city':'Nairobi', 'age':20}
print(unpacking_person_info(**dct)) # Fidel lives in Kenya, Nairobi. He is 20 years old.
```
...
print(packing_person_info(name="Fidel",
...
city = Nairobi
age = 20
{'name': 'Fidel', 'country': 'Kenya', 'city': 'Nairobi', 'age': 20}
```
